 ...
 */
class EasyPullLayout : ViewGroup, NestedScrollingParent, NestedScrollingChild {
    ...
    companion object {
        ...
        const val STATE_IDLE = 0   //初始状态
        const val STATE_ROLLING = 1     //正在滚动中...
        const val STATE_TRIGGERING = 2     //正在刷新中...

        const val DEFAULT_DURATION = 300  //默认动画时长
        const val DEFAULT_STICKY_FACTOR = 0.66f //默认粘性因子
    }
    ...
    constructor(context: Context?, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        context?.theme?.obtainStyledAttributes(attrs, R.styleable.EasyPullLayout, defStyleAttr, 0).let {
            ...
            roll_back_duration = it.getInteger(R.styleable.EasyPullLayout_roll_back_duration, DEFAULT_DURATION).toLong()
            sticky_factor = it.getFloat(R.styleable.EasyPullLayout_sticky_factor, DEFAULT_STICKY_FACTOR)
    ...
    /**
     * 自定义的layoutParams，复写系统生成的layoutParams，让系统识别自定义的layoutParams属性-------start---
     */
